...
object Strings {
  val helloMessageStr: String = "به دستیار هوشمند *کلینیک زیبایی به سیما خوش‌ آمدید* لطفا برای بهره گیری از خدمات یکی از گزینه های زیر را اتخاب کنید"

  val VisitTime       = "وقت ویزیت"
  val BehSimaServices   = "خدمات به سیما"
  val SmsBroadcastEnable      = "فعال کردن خدمات پیامکی"
  val AboutClinicAnd  = "در مورد کلینیک"
  val ClinicCrew      = "دکتر ها"
  val Support         = "پیشنهاد و انتقاد"
  val ClinicAddress   = "آدرس و تلفن کلینیک"
  val BackToMainMenu = "بازگشت به منوی اصلی"


 val AllBehSimaServices = List(
   "جوانسازی پوست و رفع چین و چروک صورت",
   "روشن سازی لکه های پوستی",
   "تزریق ژل و بوتاکس",
   "رفع موهای زائد صورت، بدن و اندام ها",
   "درمان ضایعات عروقی پوست",
   "مزوتراپی و تزریق PRP",
   "کاشت مو و ابرو",
   "و ..."
 )
  ...
  val BehsimaInfo = "کلینیک تخصصی به سیما مجهزترین مرکز تخصصی پوست و لیزر کشور است که در سال 1380 با تلاش جمعی از فارغ التحصیلان دانشگاه علوم پزشکی تهران در پاسخ به نیاز روزافزون بیماران تاسیس گردید . هدف بنیان گزاران این مجموعه ارائه خدماتی شایسته و با کیفیت و منطبق بر علم روز پزشکی بوده و بهمین لحاظ فقط از پزشکان متخصص پوست و مو عضو هیات علمی دانشگاه ها یا پزشکان صاحب نام و شناخته شده کشور دعوت به همکاری گردیده است . این مرکز با همکاری بیش از 70 پزشک متخصص همواره کوشیده است تا خدمات خود را از نظر کمی و کیفی ارتقاء بخشیده و جدیدترین تجهیزات و فنآوری های نوین را به خدمت گیرد . در این مرکز یک داروخانه تخصصی پوست و 3 اتاق عمل کاملاً مجزا و بیش از 20 دستگاه پیشرفته لیزر در دو نوبت کاری آماده ارائه خدمت به مراجعین محترم می باشند ."
