...
object StringMaker extends StringMakers with Converter with OperatorExtension {
  ...
  val ENTER_DAY_OF_FLIGHT: String = newText("لطفا روز سفر خود را وارد کنید.")
  ...
  val INVALID_COUNTRY_INPUT = "کشور وارد شده نامعتبر است. لطفا مجددا یکی از گزینه های زیر را انتخاب کنید."


  val BOT_INTRODUCTION = "دستیار اخذ وقت سفارت\nاطلاعات بیشتر و ارتباط با ادمین: @embassy_appointment_admin\n پس از ثبت درخواست وقت سفارت، کارشناسان ما با شما تماس گرفته و پس از تایید اطلاعات و تعیین هزینه های وقت سفارت درخواست شما انجام می شود.\nلازم به ذکر است که پرداخت هزینه ها، پس از انجام درخواست شما صورت می پذیرد."
